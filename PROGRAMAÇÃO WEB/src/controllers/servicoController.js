...
class ServicoController {
    ...
    async ativar(req, res) {
        try {
            await servicoService.ativarServico(req.params.id);
            res.redirect('/admin/servicos?sucesso=Serviço ativado com sucesso');
        } catch (error) {
            res.redirect('/admin/servicos?erro=Erro ao ativar serviço.');
        }
    }
}
